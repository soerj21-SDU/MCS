...
HD_PWD='C:/Git/GitHub/MCS/MC/MC_state_machine_all_functions/V2/Vivado/Vivado.runs/MC_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MC_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MC_xbar_0.tcl
