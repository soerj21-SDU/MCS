...
HD_PWD='C:/Git/GitHub/MCS/MC/MC_state_machine_all_functions/V2/Vivado/Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MC_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MC_wrapper.tcl -notrace
