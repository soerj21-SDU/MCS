...
HD_PWD='C:/B_Git/MCS/MC/MC_V1_Zybo/Vivado/project_1.runs/Block_DIagram_SDC_Monitor_CAR_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_DIagram_SDC_Monitor_CAR_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_DIagram_SDC_Monitor_CAR_0_1.tcl
