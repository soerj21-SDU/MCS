...
HD_PWD='C:/Git/GitHub/MCS/MC/MC_state_machine_xADC/V1/Vivado/Vivado.runs/MC_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MC_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MC_auto_pc_0.tcl
