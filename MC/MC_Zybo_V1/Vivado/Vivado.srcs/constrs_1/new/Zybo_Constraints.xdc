...
##Pmod Header JE
# CAN_0
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { CAN_0_rx }]; #IO_L4P_T0_34 Sch=JE1
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { CAN_0_tx }]; #IO_L3N_T0_DQS_34 Sch=JE7

# CAN_1
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { CAN_1_rx }]; #IO_L19P_T3_35 Sch=JE4
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { CAN_1_tx }]; #IO_L20P_T3_34 Sch=JE9
