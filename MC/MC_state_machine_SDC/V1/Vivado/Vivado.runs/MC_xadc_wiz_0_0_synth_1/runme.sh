...
HD_PWD='C:/Git/GitHub/MCS/MC/MC_state_machine/V1/Vivado/Vivado.runs/MC_xadc_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MC_xadc_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MC_xadc_wiz_0_0.tcl
