...
set_property IOSTANDARD LVCMOS18 [get_ports SDC_SUPPLY_I]
set_property PACKAGE_PIN G17 [get_ports COCKPIT_EMERGENCY_I]
set_property IOSTANDARD LVCMOS18 [get_ports COCKPIT_EMERGENCY_I]
set_property PACKAGE_PIN H16 [get_ports BOTS_I]
set_property IOSTANDARD LVCMOS18 [get_ports BOTS_I]
set_property PACKAGE_PIN H17 [get_ports INERTIA_I]
set_property IOSTANDARD LVCMOS18 [get_ports INERTIA_I]
set_property PACKAGE_PIN H15 [get_ports L_EMERGENCY_BUTTON_I]
set_property IOSTANDARD LVCMOS18 [get_ports L_EMERGENCY_BUTTON_I]
set_property PACKAGE_PIN G15 [get_ports R_EMERGENCY_BUTTON_I]
set_property IOSTANDARD LVCMOS18 [get_ports R_EMERGENCY_BUTTON_I]
set_property PACKAGE_PIN M15 [get_ports FR_WHEEL_I]
set_property IOSTANDARD LVCMOS18 [get_ports FR_WHEEL_I]
set_property PACKAGE_PIN M14 [get_ports FL_WHEEL_I]
set_property IOSTANDARD LVCMOS18 [get_ports FL_WHEEL_I]
set_property PACKAGE_PIN K16 [get_ports RR_WHEEL_I]
set_property IOSTANDARD LVCMOS18 [get_ports RR_WHEEL_I]
set_property PACKAGE_PIN J16 [get_ports RL_WHEEL_I]
set_property IOSTANDARD LVCMOS18 [get_ports RL_WHEEL_I]
