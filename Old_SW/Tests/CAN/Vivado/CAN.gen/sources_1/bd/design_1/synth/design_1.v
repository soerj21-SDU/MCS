...
module design_1
   (CAN_0_rx,
    ...
    UART0_RX,
    UART0_TX);
  (* X_INTERFACE_INFO = "xilinx.com:interface:can:1.0 CAN_0 " *) input CAN_0_rx;
  (* X_INTERFACE_INFO = "xilinx.com:interface:can:1.0 CAN_0 " *) output CAN_0_tx;
  (* X_INTERFACE_INFO = "xilinx.com:interface:can:1.0 CAN_1 " *) input CAN_1_rx;
  (* X_INTERFACE_INFO = "xilinx.com:interface:can:1.0 CAN_1 " *) output CAN_1_tx;
  ...
  assign UART0_CTSN_1 = UART0_CTSN;
  assign UART0_RTSN = processing_system7_0_UART0_RTSN;
