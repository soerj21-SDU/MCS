...
*********************************************************************************************************
*                                               uC/CAN
*                                       The Embedded CAN suite EDIT BY SOEREN
*
...
#define  CAN_MODULE_CHANNEL_1                   DEF_ENABLED
...
#define CANAPP_OFFSET							0x400L			/* Offset of CAN IDs */
...
#define  CANBUS_RX_QSIZE                 (100u * CANBUS_N)        /*   Receive Queue Size in CAN Frames for each CAN Bus  */
...
#define  CANSIG_N                               3u              /*   Number of signals                                  */ // NOrmally 3u
