...
proc create_root_design { parentCell } {
  ...
  set pl_leds_o [ create_bd_port -dir O -from 2 -to 0 pl_leds_o ]
  set relay_i [ create_bd_port -dir I -from 5 -to 0 relay_i ]
  set relay_o [ create_bd_port -dir O -from 2 -to 0 relay_o ]
  set shutdown_i [ create_bd_port -dir I -from 8 -to 0 shutdown_i ]
  set shutdown_o [ create_bd_port -dir O -from 1 -to 0 shutdown_o ]
  ...
  # Create instance: pl_leds, and set properties
  set pl_leds [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 pl_leds ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#USB Reset#Quad SPI Flash#GPIO#CAN 0#CAN 0#CAN 1#CAN 1#GPIO#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
  ...
  set relay [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 relay ]
  set_property -dict [ list \
  ...
  set shutdown [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 shutdown ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins pl_leds/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins relay/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins shutdown/S_AXI]

  # Create port connections
  connect_bd_net -net SPI0_MISO_I_0_1 [get_bd_ports SPI0_MISO_I_0] [get_bd_pins processing_system7_0/SPI0_MISO_I]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports pl_leds_o] [get_bd_pins pl_leds/gpio_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports relay_o] [get_bd_pins relay/gpio_io_o]
  ...
  connect_bd_net -net gpio2_io_i_0_1 [get_bd_ports relay_i] [get_bd_pins relay/gpio2_io_i]
  connect_bd_net -net gpio2_io_i_0_2 [get_bd_ports shutdown_i] [get_bd_pins shutdown/gpio2_io_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_timer_1/s_axi_aclk] [get_bd_pins pl_leds/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins relay/s_axi_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins shutdown/s_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins pl_leds/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins relay/s_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins shutdown/s_axi_aresetn]
  connect_bd_net -net shutdown_gpio_io_o [get_bd_ports shutdown_o] [get_bd_pins shutdown/gpio_io_o]
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pl_leds/S_AXI/Reg] -force
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs relay/S_AXI/Reg] -force
  assign_bd_address -offset 0x41220000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs shutdown/S_AXI/Reg] -force
