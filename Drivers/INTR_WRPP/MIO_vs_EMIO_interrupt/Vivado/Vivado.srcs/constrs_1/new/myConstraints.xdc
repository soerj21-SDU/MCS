...
# set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { GPIO_I[1] }]; #IO_L24N_T3_34 Sch=BTN1
...
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { LEDs_2lower_tri_o[1] }]; #IO_L23N_T3_35 Sch=LED1
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { GPIO_O[0] }]; #IO_0_35=Sch=LED2
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { GPIO_O[1] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=LED3
