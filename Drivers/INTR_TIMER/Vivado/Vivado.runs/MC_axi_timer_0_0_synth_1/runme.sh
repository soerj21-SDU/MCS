...
HD_PWD='C:/Users/Soeren-SDU/Downloads/Timer/Vivado/Vivado.runs/MC_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MC_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MC_axi_timer_0_0.tcl
