...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS18 } [get_ports { sws_4bits_tri_i[0] }]; #IO_L19N_T3_VREF_35 Sch=SW0
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS18 } [get_ports { leds_4bits_tri_io[0] }]; #IO_L23P_T3_35 Sch=LED0
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS18 } [get_ports { leds_4bits_tri_io[1] }]; #IO_L23N_T3_35 Sch=LED1
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS18 } [get_ports { leds_4bits_tri_io[2] }]; #IO_0_35=Sch=LED2
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS18 } [get_ports { leds_4bits_tri_io[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=LED3
...
##Pmod Header JA (XADC)
# AUX14
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS18 } [get_ports { Vaux14_p }]; # set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { xa_p[0] }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS18 } [get_ports { Vaux14_n }]; # set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { xa_n[0] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=JA1_R_N
# AUX7
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS18 } [get_ports { Vaux7_p }]; #set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { xa_p[1] }]; #IO_L22P_T3_AD7P_35 Sch=JA2_R_P
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS18 } [get_ports { Vaux7_n }]; #set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { xa_n[1] }]; #IO_L22N_T3_AD7N_35 Sch=JA2_R_N
#AUX15
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS18 } [get_ports { Vaux15_p }]; # set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { xa_p[2] }]; #IO_L24P_T3_AD15P_35 Sch=JA3_R_P
set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS18 } [get_ports { Vaux15_n }]; # set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { xa_n[2] }]; #IO_L24N_T3_AD15N_35 Sch=JA3_R_N
#AUX6
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS18 } [get_ports { Vaux6_p }]; # set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { xa_p[3] }]; #IO_L20P_T3_AD6P_35 Sch=JA4_R_P
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS18 } [get_ports { Vaux6_n }]; # set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { xa_n[3] }]; #IO_L20N_T3_AD6N_35 Sch=JA4_R_N
